...
function Sidebar() {
  ...
  return (
    <div className="px-6 w-[40%] h-[calc(100vh-6.625rem)] overflow-y-scroll overflow-x-hidden ">
      {/* Home */}
      ...
      <br />
      <p className="text-balance text-red-500 mt-3">
        © <span className="bg-yellow-200">2025 Codespry18</span>
      </p>
    </div>
  );
}
